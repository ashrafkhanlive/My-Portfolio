...
import {
  getAllProjectPageSlugs,
  getConfiguredProjectCaseStudyBySlug,
...
export async function generateStaticParams() {
  const slugs = getAllProjectPageSlugs();
...
export async function generateMetadata({
  ...
  const caseStudy =
    (await getProjectCaseStudyBySlug(slug)) ??
    getConfiguredProjectCaseStudyBySlug(slug);
...
export default async function ProjectCaseStudyPage({
  ...
  return (
    <main className="animate-fade-in-blur w-full px-4 py-16">
